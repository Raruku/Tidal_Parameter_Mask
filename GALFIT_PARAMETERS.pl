...
foreach my $DataRelease (@DataRelease) {
	...
	open my $T_plot, '>', "Del_Parameters_$DataRelease.csv";

	print $T_plot "ID_bulge,MAG_AUTO_bulge,MAGERR_AUTO_bulge,GAL_MAG_bulge,SDSS_Re_bulge,GAL_Re_bulge,Kron_bulge,Fit_Type_bulge,sersic_bulge,GAL_x_bulge,GAL_y_bulge,SEX_x_bulge,SEX_y_bulge,SEX_e_bulge,SEX_theta_bulge,GAL_e_bulge,GAL_theta_bulge,ID_disk,MAG_AUTO_disk,MAGERR_AUTO_disk,GAL_MAG_disk,SDSS_Re_disk,GAL_Re_disk,Kron_disk,Fit_Type_disk,sersic_disk,GAL_x_disk,GAL_y_disk,SEX_x_disk,SEX_y_disk,SEX_e_disk,SEX_theta_disk,GAL_e_disk,GAL_theta_disk\n";
